...
Git记录了不同版本的信息，结合以上功能，我们就可以愉快的比较不同版本的差异了，更方便大家协同写文档。请使用官方 git-latexdiff：
\url{https://gitlab.com/git-latexdiff/git-latexdiff} ，
TeX Live 中也可直接安装（例如 \verb|tlmgr install git-latexdiff|）。
官方版本可用 \verb|--latexpand| 把参数传给 latexpand，遇到注释相关报错时加上 \verb|--keep-comments| 即可。
