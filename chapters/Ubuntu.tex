...
\item （可能需要）预装g++，\verb*|sudo apt-get install build-essential|；
...
\section{重装显卡驱动}
卸载：\verb|sudo apt remove --purge nvidia*|

检测显卡型号以及推荐驱动型号：\verb|ubuntu-drivers devices|

安装推荐驱动：\verb|sudo ubuntu-drivers autoinstall|
