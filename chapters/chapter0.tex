...
\url{https://scholar.google.com} ，先注册账号。常用功能见后文「文献检索与跟踪——Google学术」。

\subsection{ResearchGate}
\url{https://www.researchgate.net} ，学术社交与论文跟踪平台，可关注作者、提问讨论、请求全文。

\subsection{ORCID}
\url{https://orcid.org} ，研究者唯一标识，投稿和基金申请时常需要。早期文档中写作 OCRC，即此。
